...
import edu.starterkit.aop.logger.LoggerInterceptor;
...
@AdditionalClasses({BookServiceImpl.class, BookDaoImpl.class, BookDaoHibernateImpl.class, BookDaoAdvisor.class, LoggerInterceptor.class})
